...
// Simple role-based route components
...
export const EmployeeRoute = ({ children }) => {
  const { isAuthenticated, isAdmin, isManager, isEmployee, loading } = useAuth();
...
export const CashierRoute = ({ children }) => {
  const { isAuthenticated, isAdmin, isManager, isCashier, loading } = useAuth();
