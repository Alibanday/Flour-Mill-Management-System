                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {loading ? (
                        ...
                        filteredAccounts.map((account) => (
                          <tr onClick={() => handleClick(account._id)}  key={account._id || account.id} className="hover:bg-blue-50">
                            ...
                            <td className={`px-6 py-4 whitespace-nowrap text-sm ${
                              (account.creditLimit || "").toString().includes('-') ? 'text-red-600' : 'text-green-600'
                            }`}>
