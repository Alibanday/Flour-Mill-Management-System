        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">Loading Wheat Sales Management...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center space-x-4">
                            ...
                            <h1 className="text-2xl font-bold text-gray-900">Wheat Sales Management</h1>
                        </div>
                        <div className="flex items-center space-x-4">
                            <button
                                onClick={() => {
                ...
                <div className="bg-white rounded-lg shadow">
                    <div className="px-6 py-4 border-b border-gray-200">
                        <div className="flex justify-between items-center">
                            <h3 className="text-lg font-medium text-gray-900">Wheat Sales Records ({sales.length})</h3>
                            <button
                                onClick={() => {
                                    setEditData(null);
                                    setShowSalesForm(true);
                    ...
                    <div className="p-6">
                        {sales.length === 0 ? (
                            <p className="text-gray-500 text-center py-8">No wheat sales records found. Create your first sale above.</p>
                        ) : (
